...
namespace SalesForce_Project.Pages.Company
{
    class CompanyListHomePage : BaseClass
    {
        ...
        By lnkAlphabelC = By.CssSelector("div[id='000000000000000_rolodex'] > a:nth-child(3)");
        ...
        By pinIndicator = By.XPath("//span[@id='pinIndicator']");
        ...
        {         
            //WebDriverWaits.WaitUntilEleVisible(driver, pinIndicator, 120);
