...
namespace SF_Automation.Pages.Opportunity
{
    class CNBCForm : BaseClass
    {
        ...
        By txtEstimatedFee = By.XPath("//input[@name='Transaction_Value_for_Fee_Calc__c']");
        ...
        By chkNextSchCallCNBC = By.XPath("//input[@name='Next_Scheduled_Call__c']");
        By chkFeedbackCNBC = By.XPath("//input[@name='Req_feedback_prior_to_normal_sched_call__c']");
        By txtDate = By.XPath("//label[text()='Date']/ancestor::div[1]//input[@name='Scheduled_call_date_time__c']");
        By txtTime = By.XPath("//label[text()='Time']/ancestor::lightning-timepicker[1]//input[@name='Scheduled_call_date_time__c']");
        ...
        By lblHLComp = By.XPath("//div/span[text()='Houlihan Lokey Competition']");
        ...
        By lblUseOfPro = By.XPath("//span[text()='Use of Proceeds']");
        By lblProDetails = By.XPath("//span[text()='Use of Proceeds Detail']");
        ...
        By lblOwnership = By.XPath("//span[text()='Ownership and Capital Structure']");
        By secTotalDebt = By.XPath("//span[@title='Total Debt(MM)']");
        By lblTotalDebt = By.XPath("//span[text()='Total Debt (MM)']");
        ...
        By lblPrePitch = By.XPath("//span[text()='Will There Be a Pitch?']");

        By secStrcuture = By.XPath("//span[@title='Structure and Pricing Expectations (if relevant)']");
        By lblStrcuture = By.XPath("//span[text()='Structure and Pricing Expectations']");
        By secReferral = By.XPath("//span[@title='Referral']");
        By lblReferralType = By.XPath("//span[text()='Referral Type']");
        By lblReferralSource = By.XPath("//span[text()='Referral Source']");
        By secPls = By.XPath("//span[@title='Please confirm that a group head has approved prior to submitting to the committee']");
        By lblGroup = By.XPath("//div/span[text()='Group Head Approval']");
        ...
        By valOppNum = By.XPath("//p[7]/span");
        ...
        public void UpdateReviewSubmissionAndUpdateReferralFee()
        {
            ...
            driver.FindElement(txtEstimatedFee).SendKeys("15");
            Thread.Sleep(3000);
            ...
            Thread.Sleep(6000);
            driver.FindElement(chkNextSchCallCNBC).Click();
            Thread.Sleep(4000);
            driver.FindElement(btnSave).Click();
        ...
        public string UpdateGrade()
        {
            ...
            Thread.Sleep(4000);
            driver.FindElement(chkNextSchCallCNBC).Click();
            driver.FindElement(chkFeedbackCNBC).Click();
            Thread.Sleep(4000);
            driver.FindElement(txtDate).SendKeys("10/16/2025");
            Thread.Sleep(8000);
            driver.FindElement(txtTime).Click();
            Thread.Sleep(5000);
            driver.FindElement(txtTime).Clear();
            driver.FindElement(txtTime).SendKeys("12:00 PM");
            Thread.Sleep(6000);
            driver.FindElement(btnSave).Click();
            Thread.Sleep(6000);
