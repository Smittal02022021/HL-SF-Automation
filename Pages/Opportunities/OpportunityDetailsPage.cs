...
namespace SF_Automation.Pages
{
    class OpportunityDetailsPage : BaseClass
    {
        ...
        By btnLocationBenefitL = By.XPath("//button[contains(@aria-label,'Location where Benefit')]");
        ...
        //Lightning
        By comboLegalAdvisorHLL = By.XPath("//button[contains(@aria-label,'Legal Advisor to HL Client Group')]");
        ...
        By btnEditOppL = By.XPath("//li[contains(@data-target-selection-name,'Opportunity__c.Edit')]"); //records-lwc-highlights-panel/records-lwc-record-layout//records-highlights2/div[1]/div[1]/div[3]/div/runtime_platform_actions-actions-ribbon/ul/li[1]/runtime_platform_actions-action-renderer"); 
        ...
        By valStatusL = By.XPath("//h1[text()='Approval History']/ancestor::div[6]/div[2]//tbody/tr[1]/td[3]//span/span");
        ...
        By valEstTxnSizeL = By.XPath("//flexipage-tab2[2]//flexipage-component2[3]//flexipage-column2[1]//flexipage-field[1]//slot[1]/lightning-formatted-text");
        By valEstTxnSizeOppL = By.XPath("//span[text()='Est. Transaction Size / Market Cap (MM)']/ancestor::div[2]//lightning-formatted-text");
        // By valEstTxnSize = By.XPath("//div[contains(@id, 'P4j')]");
        By btCurrencyFee = By.XPath("//span[text()='Currency']/ancestor::div[2]//div//button");
        By lnkEditRetainer = By.XPath("//span[text()='Currency']/ancestor::div[2]/following::div/button[@title='Edit Retainer']");
        ...
        By valOppNameL = By.XPath("//div/span[text()='Opportunity Name']/ancestor::div[2]//div/span//lightning-formatted-text");
        ...
        By btnAddFRContact = By.XPath("//button[@name='Opportunity__c.Add_FR_Opportunity_Contact']");
        ...
        By txtOppNumberL = By.XPath("//span[text()='Opportunity Number']/../../..//lightning-formatted-text");//span[contains(@class,'field-label')][normalize-space()='Opportunity Number']/parent::div/following-sibling::div//lightning-formatted-text");
        ...
        By txtOppNameL = By.XPath("//span[text()='Opportunity Name']/../../..//lightning-formatted-text");//span[contains(@class,'field-label')][normalize-space()='Opportunity Name']/ancestor::dt/following-sibling::dd//lightning-formatted-text");//::dl//dd//lightning-formatted-text");////span[contains(@class,'field-label')][normalize-space()='Opportunity Name']/parent::div/following-sibling::div//lightning-formatted-text");
        ...
        By lblHLSectorIDL = By.XPath("//label[text()='Sector']");//HL Sector ID
        ...
        By valLOBL = By.XPath("//flexipage-field[contains(@data-field-id,'Line_of_Business')]//lightning-formatted-text");
        By valAdditionalClientL2 = By.XPath("//div[contains(@data-target-selection-name,'RecordField.Opportunity__c.Additional_Client')]//lightning-formatted-text");
        By valAdditionalSubjectL2 = By.XPath("//div[contains(@data-target-selection-name,'RecordField.Opportunity__c.Additional_Subject')]//lightning-formatted-text");
        By valAdditionalReferralTypeL = By.XPath("//div[contains(@data-target-selection-name,'RecordField.Opportunity__c.Referral_Type')]//lightning-formatted-text");
        By valAdditionalBeneficialOwnerControlPersonL = By.XPath("//div[contains(@data-target-selection-name,'RecordField.Opportunity__c.Beneficial_Owner_Control_Person_form')]//lightning-formatted-text");
        By valPrimaryOfficeL = By.XPath("//div[contains(@data-target-selection-name,'RecordField.Opportunity__c.Primary_Office')]//lightning-formatted-text");
        By valLegalEntityL = By.XPath("//div[contains(@data-target-selection-name,'RecordField.Opportunity__c.Legal_Entity')]//a//span/slot/span/slot");
        By valExternalDisclosureStateL = By.XPath("//div[contains(@data-target-selection-name,'RecordField.Opportunity__c.External_Disclosure_Status')]//lightning-formatted-text");
        By valStaffMemberL = By.XPath("//table[contains(@id,'HLInternalTeam')]//tbody//tr[1]//td[1]//label");
        ...
        public string CreateNewFSOppLV(string sponsor)
        {
            ...
            Thread.Sleep(2000);
            driver.FindElement(comboSubGrpL).Click();
            WebDriverWaits.WaitUntilEleVisible(driver, optionSubGrpL, 10);
            driver.FindElement(optionSubGrpL).Click();
            driver.FindElement(btnSaveDetailsL).Click();
            Thread.Sleep(2000);
            WebDriverWaits.WaitUntilEleVisible(driver, txtFSOppNameL, 10);
            return driver.FindElement(txtFSOppNameL).Text;
        }

        public string GetFSOppIDLV()
        {
            WebDriverWaits.WaitUntilEleVisible(driver, txtFSOppIDL, 10);
            return driver.FindElement(txtFSOppIDL).Text;
        }
        ...
        public bool IsVerballyEngagedEngCreatedLV(string oppName)
        {
            ...
            try
            {
                ...
                WebDriverWaits.WaitUntilEleVisible(driver, txtEngOppPage, 10);
                return driver.FindElement(txtEngOppPage).Displayed;
            }
            catch
            {
                return false;
        ...
        public void ClickVerballyEngLinkLV(string oppName)
        {
            ...
            By txtEngOppPage = By.XPath($"//article[@aria-label='Engagements']//h3//a//slot[text()='{oppName}']");
            WebDriverWaits.WaitUntilEleVisible(driver, txtEngOppPage, 20);
            By lnkEngOppPage = By.XPath($"//article[@aria-label='Engagements']//h3//a//slot[text()='{oppName}']//ancestor::records-hoverable-link");
            driver.FindElement(lnkEngOppPage).Click();
        }
        public string GetStaffMemberLV()
        {
            driver.Navigate().Refresh();
            Thread.Sleep(8000);
            ...
            Thread.Sleep(5000);
            WebDriverWaits.WaitUntilEleVisible(driver, valStaffMemberL, 10);
            string staffMember = driver.FindElement(valStaffMemberL).Text;
            driver.SwitchTo().DefaultContent();
            return staffMember;
        }

        public string GetExternalDisclosureStatusLV()
        {
            CustomFunctions.MoveToElement(driver, driver.FindElement(valExternalDisclosureStateL));
            WebDriverWaits.WaitUntilEleVisible(driver, valExternalDisclosureStateL, 10);
            string extDisclosureStat = driver.FindElement(valExternalDisclosureStateL).Text;
            return extDisclosureStat;
        }
        public string GetSectorLV()
        {
            WebDriverWaits.WaitUntilEleVisible(driver, txtHLSectorL, 10);
            string sector = driver.FindElement(txtHLSectorL).Text;
            return sector;
        }
        //To get Legal entity    
        public string GetLegalEntityLV()
        {
            CustomFunctions.MoveToElement(driver, driver.FindElement(valPrimaryOfficeL));
            WebDriverWaits.WaitUntilEleVisible(driver, valLegalEntityL, 10);
            string legalEntity = driver.FindElement(valLegalEntityL).Text;
            return legalEntity;
        }
...
        public string GetPrimaryOfficeLV()
        {
            CustomFunctions.MoveToElement(driver, driver.FindElement(valPrimaryOfficeL));
            WebDriverWaits.WaitUntilEleVisible(driver, valPrimaryOfficeL, 10);
            string primaryOffice = driver.FindElement(valPrimaryOfficeL).Text;
            return primaryOffice;
        }

        public string GetBeneOwnerAndControlPersonFormLV()
        {
            CustomFunctions.MoveToElement(driver, driver.FindElement(valAdditionalBeneficialOwnerControlPersonL));
            WebDriverWaits.WaitUntilEleVisible(driver, valAdditionalBeneficialOwnerControlPersonL, 10);
            string beneOwner = driver.FindElement(valAdditionalBeneficialOwnerControlPersonL).Text;
            return beneOwner;
        }

        public string GetReferalTypeLV()
        {
            CustomFunctions.MoveToElement(driver, driver.FindElement(valAdditionalReferralTypeL));
            WebDriverWaits.WaitUntilEleVisible(driver, valAdditionalReferralTypeL, 10);
            string ReferalType = driver.FindElement(valAdditionalReferralTypeL).Text;
            return ReferalType;
        }

        public string GetAdditionalClientLV()
        {
            CustomFunctions.MoveToElement(driver, driver.FindElement(valAdditionalClientL2));
            WebDriverWaits.WaitUntilEleVisible(driver, valAdditionalClientL2, 10);
            string addClient = driver.FindElement(valAdditionalClientL2).Text;
            return addClient;
        }
        //To get additional subject value     
        public string GetAdditionalSubjectLV()
        {
            CustomFunctions.MoveToElement(driver, driver.FindElement(valAdditionalSubjectL2));
            WebDriverWaits.WaitUntilEleVisible(driver, valAdditionalSubjectL2, 10);
            string addSubject = driver.FindElement(valAdditionalSubjectL2).Text;
            return addSubject;
        }
        ...
        {
            WebDriverWaits.WaitUntilEleVisible(driver, valLOBL, 20);
        ...
        //Validate additional Subject added from Additional Client/Subject Pop up
        public string ValidateAdditionalSubjectFromPopUpL(string jobType, string name, string value)
        {
...
            WebDriverWaits.WaitUntilEleVisible(driver, By.Id("resultsFrame"));
        ...
        //To Click Mass Edit Records button button
        public string ClickMassEditRecordsButtonL(string jobType, string value)
        {
            if (jobType.Equals("Creditor Advisors") && value.Equals("Client"))
            {
        ...
        public string ValidateNBCFormButtonLightning(string user)
        {
            try
            {
        ...
        {
            IJavaScriptExecutor jse = (IJavaScriptExecutor)driver;
            IWebElement elelinkContractName = driver.FindElement(By.XPath($"//table[@aria-label='Contract']//tbody//a//slot/span[text()='{contractName}']//ancestor::a")); ///.."));
        ...
        // To validate save functionality of Additional client
        public string ValidateSaveFunctionalityOfAdditionalClientL(string name, string type, string recordType)
        {
            if (type.Equals("Creditor Advisors") && name.Equals("Accupac"))
            {
        ...
        //Get type of added additional client record
        public string GetTypeOfAdditionalClientEngL(string name)
        {
            Thread.Sleep(5000);
            driver.FindElement(tabClientL).Click();
            Thread.Sleep(6000);
        ...
        public string ClickApproveButtonLV2()
        {
            Thread.Sleep(4000);
            IJavaScriptExecutor js = (IJavaScriptExecutor)Driver;
            js.ExecuteScript("window.scrollTo(0,0)");
        ...
        public void UpdateReqFieldsForFVAConversionL(string file)
        {
            ReadJSONData.Generate("Admin_Data.json");
            string dir = ReadJSONData.data.filePaths.testData;
            string excelPath = dir + file;
        ...
        {
            driver.FindElement(By.XPath("//span[text()='Client Ownership']/ancestor::div[2]//button")).Click();
            Thread.Sleep(4000);
            driver.FindElement(btnClientOwnership).Click();
            Thread.Sleep(7000);
...
        public void UpdateReqFieldsForCFConversionL2(string file)
        ...
        {
            WebDriverWaits.WaitUntilEleVisible(driver, tabApprovalHistoryL, 10);
            Thread.Sleep(2000);
        ...
        public void UpdateLocationBenefitLV(string benefit)
        {
            WebDriverWaits.WaitUntilEleVisible(driver, btnEditL, 10);
            driver.FindElement(btnEditL).Click();
            Thread.Sleep(4000);
            //Location where Benefit was Provided
            WebDriverWaits.WaitUntilEleVisible(driver, txtDateEngL, 10);
            CustomFunctions.MoveToElement(driver, driver.FindElement(txtDateEngL));
            WebDriverWaits.WaitUntilEleVisible(driver, btnLocationBenefitL, 10);
            driver.FindElement(btnLocationBenefitL).Click();
            Thread.Sleep(2000);
            driver.FindElement(By.XPath($"//label[text()='Location where Benefit is to be Provided']/following::lightning-base-combobox-item//span[text()='{benefit}']")).Click();
            driver.FindElement(btnSaveDetailsL).Click();
        ...
        public void UpdateReqFieldsForCFConversionWithoutLocationBenefitLV(string file, string valJobType)
        {
            ReadJSONData.Generate("Admin_Data.json");
            string dir = ReadJSONData.data.filePaths.testData;
            string excelPath = dir + file;
        ...
        public void UpdateReqFieldsForCFConversionMultipleRows(string file, string valJobType, int rowCount)
        {
            ReadJSONData.Generate("Admin_Data.json");
            string dir = ReadJSONData.data.filePaths.testData;
            string excelPath = dir + file;
            ...
            string valSubject = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 19);
            driver.FindElement(comboSubjectOwnershipL).SendKeys(valSubject);
            Thread.Sleep(3000);
            By eleSubjectOwnership = By.XPath($"//label[text()='Subject Ownership']/following::lightning-base-combobox-item//span[@title='{valSubject}']");
            CustomFunctions.MoveToElement(driver, driver.FindElement(eleSubjectOwnership));
            ...
            WebDriverWaits.WaitUntilEleVisible(driver, txtOppDescL2, 20);
            CustomFunctions.MoveToElement(driver, driver.FindElement(txtOppDescL2));
            driver.FindElement(txtOppDescL2).SendKeys(ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 21));

            //Estimated Fees
            string valRetainerL = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 15);
            CustomFunctions.MoveToElement(driver, driver.FindElement(lblFeeNotesDes));
            driver.FindElement(txtRetainerL).SendKeys(valRetainerL);
            //CustomFunctions.MoveToElement(driver, driver.FindElement(txtTailExpiresL));
            //driver.FindElement(txtTailExpiresL).SendKeys("07/01/2023");
            driver.FindElement(txtMonthlyL).SendKeys(ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 15));
            driver.FindElement(txtContigentL).SendKeys(ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 15));

            //New required fields for CF conversion 
            driver.FindElement(txtSharedServExpL).SendKeys(ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 15));
            driver.FindElement(txtEstimatedCapL).SendKeys(ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 15));
            driver.FindElement(txtLegalCapL).SendKeys(ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 15));

            //Ref Contact
            string valRef = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 22);
            CustomFunctions.MoveToElement(driver, driver.FindElement(lblAdditionalClient));
            if (valJobType == "Lender Education")
            {
                driver.FindElement(txtRefContactL2).SendKeys(valRef);
            ...
            string valWomen = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 6);
            if (valJobType == "Sellside")
            {
                driver.FindElement(txtEBITDAL).SendKeys(ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 15));
                Thread.Sleep(2000);
            }
            ...
            //Funds & Financials
            driver.FindElement(txtEstTxnSizeL).SendKeys(ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 15));
            ...
            driver.FindElement(btnLocationBenefitL).Click();
            Thread.Sleep(4000);
            driver.FindElement(By.XPath("//label[contains(text(),'Location where Benefit')]/following::lightning-base-combobox-item//span[text()='Benefit is likely >75% outside the US']")).Click();
...
                driver.FindElement(linkCoverageSectorDependencyName).Click();
        ...
        public void UpdateTotalDebtConfirmedLV()
        {
            ...
            Thread.Sleep(2000);
            CustomFunctions.MoveToElement(driver, driver.FindElement(btnSaveDetailsL));
            Thread.Sleep(2000);
            driver.FindElement(btnSaveDetailsL).Click();
            Thread.Sleep(5000);
        }
        public void UpdateTotalDebtConfirmedLV2()
        {
            IJavaScriptExecutor js = (IJavaScriptExecutor)driver;
            WebDriverWaits.WaitUntilEleVisible(driver, btnEditL, 20);
            driver.FindElement(tabInfo).Click();
        ...
        public void UpdateReqFieldsForFVAConversionWithoutLocationBenefitLV(string file)
        {
            ReadJSONData.Generate("Admin_Data.json");
            string dir = ReadJSONData.data.filePaths.testData;
            string excelPath = dir + file;
        ...
        public void UpdateTASServicesLV()
        {
            ...
            driver.FindElement(btnEditL).Click();
            Thread.Sleep(4000);
            WebDriverWaits.WaitUntilEleVisible(driver, editPageSectionTabL, 20);
            CustomFunctions.MoveToElement(driver, driver.FindElement(editPageSectionTabL));
            Thread.Sleep(1000);
        ...
        public void CloseConversionPopup()
        {
            ...
            catch
            {
                try
                {
                    WebDriverWaits.WaitUntilEleVisible(driver, iconCloseConversionPopup2, 10);
                    driver.FindElement(iconCloseConversionPopup2).Click();
                }
                catch
        ...
        {
            Thread.Sleep(6000);
            WebDriverWaits.WaitUntilEleVisible(driver, btnEditOppL, 10);
            CustomFunctions.MoveToElement(driver, driver.FindElement(btnEditOppL));
            driver.FindElement(btnEditOppL).Click();
            WebDriverWaits.WaitUntilEleVisible(driver, headerEditBox, 20);
        ...
        By btnNewFSOppL = By.XPath("//article[@aria-label='FS Opps']//button[@name='New']");
