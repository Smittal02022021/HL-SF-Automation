...
namespace SF_Automation.Pages
{
    class AddOpportunityPage : BaseClass
    {
        ...
        By comboSector = By.CssSelector("select[name*= '0PI']");
        ...
        By valTitleL = By.XPath("//h2[contains(text(),'New Opportunity')]");
        By valLOBL = By.XPath("//label[text()='Line of Business']/following::div[1]//button");
        By btnClearClientL = By.XPath("//label[text()='Client']/following::div[1]/div/lightning-base-combobox//input/../../..//button");
        By btnCancelL = By.XPath("//button[@name='CancelEdit']");
        By txtRecordTypeL = By.XPath("//span[text()='Record Type']/../../..//records-record-type//span");
        By btnMNPI1 = By.XPath("//label[text()='What MNPI did HL receive?']/ancestor::div[1]/div/lightning-base-combobox//button");
        By btnDNDReqL = By.XPath("//label[text()='Should this deal qualify for DND?']/ancestor::div[1]/div/lightning-base-combobox//button");
        By inputDNDReasonL = By.XPath("//label[text()='Please explain the reason for DND']/ancestor::div[1]//textarea");
        public void ClickCancelAddOpportunityPageLV()
        {
        ...
        public string GetRecordTypeLV()
        {
            ...
            CustomFunctions.MoveToElement(driver, driver.FindElement(txtRecordTypeL));
            Thread.Sleep(2000);
            return driver.FindElement(txtRecordTypeL).Text;
        }

        public string AddCompanyOpportunitiesLightningView(string companyName, string valRecordType, string type, string file)
        {
            ...
            driver.FindElement(txtClientL).SendKeys(companyName);
            Thread.Sleep(5000);
            By eleClient = By.XPath($"//label[text()='Client']/following::ul//lightning-base-combobox-item//lightning-base-combobox-formatted-text[@title='{companyName}']");
            ...
            driver.FindElement(txtSubjectL).SendKeys(companyName);
            Thread.Sleep(5000);
            By eleSubject = By.XPath($"//label[text()='Subject']/following::ul//lightning-base-combobox-item//lightning-base-combobox-formatted-text[@title='{companyName}']");
            ...
            ////string valIG = "CSDN-0000006544"; // "CSDN -0000007072";
            //string valIG = ReadExcelData.ReadData(excelPath, "AddOpportunity", 4);
            ...
            {
                string valFee = ReadExcelData.ReadData(excelPath, "AddOpportunity", 17);
        ...
        public void ClearPreFilledMandatoryValuesOnAddOpportunityLV()
        {
            IJavaScriptExecutor jse = (IJavaScriptExecutor)driver;
            WebDriverWaits.WaitUntilClickable(driver, btnClearClientL, 10);
            jse.ExecuteScript("arguments[0].click();", driver.FindElement(btnClearClientL));
            //driver.FindElement(btnClearClientL).Click();
            Thread.Sleep(2000);
        }

        public string GetPrefilledLineOfBusinessLV()
        {
            WebDriverWaits.WaitUntilEleVisible(driver, valLOBL, 10);
            string prefilledLOB = driver.FindElement(valLOBL).GetAttribute("data-value");
            return prefilledLOB;
        }
        public string GetPrefilledClientNameLV()
        {
            Thread.Sleep(5000);
            WebDriverWaits.WaitUntilEleVisible(driver, txtClientL, 20);
            string prefilledClientName = driver.FindElement(txtClientL).GetAttribute("value");
            return prefilledClientName;
        }
        public string GetNewOpportunityPageHeadingLV()
        {
            Thread.Sleep(8000);
            WebDriverWaits.WaitUntilEleVisible(driver, valTitleL, 20);
            string title = driver.FindElement(valTitleL).Text;
            return title;
        }
        ...
        public string AddOpportunitiesLightning(string type, string file)
        {
            ...
            //string valIG = ReadExcelData.ReadData(excelPath, "AddOpportunity", 5);
            //CustomFunctions.MoveToElement(driver, driver.FindElement(inputHLSectorIDL));
            //driver.FindElement(inputHLSectorIDL).SendKeys(valIG);
            //WebDriverWaits.WaitUntilEleVisible(driver, listHLSectorL, 20);
            //driver.FindElement(listHLSectorL).Click();
            ...
            if (valRecordType == "FVA")
            {
                string valFee = ReadExcelData.ReadData(excelPath, "AddOpportunity", 27);
                driver.FindElement(txtEstFee).SendKeys(valFee);
            }
            else
            {
                Console.WriteLine("No fee required");
            }
            ...
            {
                driver.FindElement(By.XPath("//button[@aria-label='Beneficial Owner & Control Person form?']/ancestor::div[2]/div[2]/lightning-base-combobox-item[3]//span[2]/span")).Click();
                Thread.Sleep(4000);
            ...
            {
                driver.FindElement(By.XPath("//button[@aria-label='Does HL Have Material Non-Public Info?']/ancestor::div[2]/div[2]/lightning-base-combobox-item[3]//span[2]/span")).Click();
            }
            else
            {
                driver.FindElement(By.XPath("//button[@aria-label='Does HL Have Material Non-Public Info?']/ancestor::div[2]/div[2]/lightning-base-combobox-item[3]//span[2]/span")).Click();
        ...
        public string AddOpportunitiesMutipleRows(string type, string file, int rowCount)
        {
            IJavaScriptExecutor jse = (IJavaScriptExecutor)driver;
            ReadJSONData.Generate("Admin_Data.json");
            string dir = ReadJSONData.data.filePaths.testData;
            ...
            string valRecordType = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 25);
            //--------------------------Enter Opportunity details-----------------------------
            //Information Section           
            WebDriverWaits.WaitUntilEleVisible(driver, txtOpportunityNameL, 240);
            string valOpportunity = CustomFunctions.RandomValue();
            ...
            driver.FindElement(txtOpportunityNameL).SendKeys(valOpportunity);
            string valClient = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 1);
            driver.FindElement(txtClientL).SendKeys(valClient);
            Thread.Sleep(5000);
            By eleClient = By.XPath($"//label[text()='Client']/following::ul//lightning-base-combobox-item//lightning-base-combobox-formatted-text[@title='{valClient}']");
            ...
            string valSubject = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 2);
            driver.FindElement(txtSubjectL).SendKeys(valSubject);
            Thread.Sleep(5000);
            By eleSubject = By.XPath($"//label[text()='Subject']/following::ul//lightning-base-combobox-item//lightning-base-combobox-formatted-text[@title='{valSubject}']");
            ...
            //Select IG
            string valIG = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 4);
            Thread.Sleep(3000);
            ...
            //Select sector
            string valSector = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 5);
            CustomFunctions.MoveToElement(driver, driver.FindElement(txtSICL));
            driver.FindElement(comboSectorL).Click();
            By eleSector = By.XPath($"//label[text()='Sector']/following::lightning-base-combobox-item//span[@title='{valSector}']");
            CustomFunctions.MoveToElement(driver, driver.FindElement(eleSector));
            ...
            //Select Primary Office
            string valPO = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 11);
            CustomFunctions.MoveToElement(driver, driver.FindElement(lblWomenLed));
            driver.FindElement(comboPrimaryOfficeL).Click();
            By elePO = By.XPath($"//label[text()='Primary Office']/following::lightning-base-combobox-item//span[@title='{valPO}']");
            CustomFunctions.MoveToElement(driver, driver.FindElement(elePO));
            ...
            //Select Legal Entity
            string valEntity = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 12);
            CustomFunctions.MoveToElement(driver, driver.FindElement(txtLegalEntitiesL));
            driver.FindElement(txtLegalEntitiesL).SendKeys(valEntity);
            Thread.Sleep(3000);
            By eleLegalEntity = By.XPath($"//label[text()='Legal Entity']/following::ul//lightning-base-combobox-item//lightning-base-combobox-formatted-text[@title='{valEntity}']");
            ...
            if (valRecordType == "FVA")
            {
                string valFee = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 28);
                CustomFunctions.MoveToElement(driver, driver.FindElement(comboRefTypeL));
                driver.FindElement(txtEstFee).SendKeys(valFee);
            }
            //Select Referral Type //Need to move in UpdteReq function  
            string valRefType = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 8);
            CustomFunctions.MoveToElement(driver, driver.FindElement(lblCongAgg));
            if (valRecordType == "CF" || valRecordType == "FVA")
            {
                driver.FindElement(comboRefTypeL).Click();
            ...
            //Select Beneficial Owner
            string valBenOwner = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", rowCount, 10);
            CustomFunctions.MoveToElement(driver, driver.FindElement(lblCongAgg));
            Thread.Sleep(1000);
            driver.FindElement(comboBenOwnerL).Click();
            Thread.Sleep(1000);
        ...
        public string ValidatePageWhenInitiatorRoleIsSelected()
        {
            ...
            driver.FindElement(btnRecentlyViewed).Click();
            Thread.Sleep(4000);
            driver.FindElement(By.XPath("//div[1]/div/ul/li//span[text()='Opportunities']")).Click();
            Thread.Sleep(4000);
            WebDriverWaits.WaitUntilEleVisible(driver, valRec1st, 240);
            driver.FindElement(valRec1st).Click();
            Thread.Sleep(8000);
