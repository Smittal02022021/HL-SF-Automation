...
namespace SF_Automation.Pages.Contact
{
    class ContactDetailsPage : BaseClass
    {
        ...
        By txtActivitySubjectOnDetail = By.XPath("(//th[text()='Subject']/following::td/span)[1]");
     ...
     // By btnTodaysActivities = By.CssSelector("#j_id0\\:j_id1\\:j_id2\\:j_id3\\:pbActivityLog\\:j_id9\\:j_id10");//("input[id*='j_id9:j_id10']");
       ...
       // By checkboxFirstContact = By.XPath("//td[text()='testsummer@email.com']//parent::tr/th/input");
        ...
        By checkboxDoNotSolicit = By.XPath("(//*[contains(text(),'Do Not Solicit')]/following::td/input)[1]");
        By checkboxManualOptOut = By.XPath("(//*[contains(text(),'Manual Opt Out')]/following::td/input)[1]");

        By lblJobCode = By.XPath("//*[text()='Job Code']");
        By lblJobCodeValue = By.XPath("(//*[text()='Job Code']/following::div)[1]");
        ...
        By linkShowFilters = By.XPath("//*[@id='showFiltersIdCoverage_Sector_Dependency__c']");
