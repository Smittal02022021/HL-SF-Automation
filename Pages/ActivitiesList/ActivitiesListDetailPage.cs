...
namespace SF_Automation.Pages.ActivitiesList
{
    class ActivitiesListDetailPage : BaseClass
    {
        ...
        public void enterExternalContact()
        {
            ...
            driver.FindElement(txtExternalContactActivityPage).Clear();
            driver.FindElement(txtExternalContactActivityPage).SendKeys("Test External");

            Thread.Sleep(3000);
            WebDriverWaits.WaitUntilEleVisible(driver, By.XPath("//body/ul[1]/li/a"), 30000);
            driver.FindElement(By.XPath("//body/ul[1]/li/a")).Click();
