...
{
    class TMT0072178_TMT0072180_VerifyBothPrimaryAndNonPrimaryAttendeeCanDeleteActivityFromSF : BaseClass
    {
        ...
        public static string fileTMTC0032668 = "TMTC0032668_VerifyBothPrimaryAndNonPrimaryAttendeeCanDeleteActivityFromSF";
        ...
        [Test]
        public void VerifyBothPrimaryAndNonPrimaryAttendeeCanDeleteActivityFromSF()
        {
            try
            {
                ...
                //TMT0072178 Verify that the primary attendee of the activity can "Delete" the activity from Salesforce.
                //TMT0072180 Verify that the Non-primary attendee of the activity can "Delete" the activity from Salesforce.
                ...
                for(int row = 2; row <= totalActivity; row++)
                {
                    ...
                    if(row == 2)
                    {
                        ...
                        extentReports.CreateStepLogs("Passed", "Primary Attendee of the activity is able to delete the activity successfully. ");
                    }
                    else
                    {
