...
namespace SF_Automation.TestCases.LV_Activities
{
    class TMTT0046706_VerifyFunctionalityOfAddNewCompanyFromAddNewActivityPage : BaseClass
    {
        ...
        public static string fileTMTT0046706 = "TMTT0046706_VerifyFunctionalityOfAddNewCompanyFromAddNewActivityPage";
        ...
        public void VerifyFunctionalityOfAddNewCompanyFromAddNewActivityPage()
        {
            try
            {
                //Get path of Test data file
                string excelPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"..\..\TestData", fileTMTT0046706 + ".xlsx");
                ...
                extentReports.CreateStepLogs("Info", "User clicked on Add New Activity button. ");

                addActivity.ClickAddNewCompanyBtn();
                extentReports.CreateStepLogs("Info", "User clicked on Add New Company button. ");

                // TMTI0114009 - Verify Country specific error message is displayed on creating a new company from add new activity page without "Country" information.
                string countryErrorMessage = addActivity.GetCountryErrorMessage(fileTMTT0046706);

                string countryErrExcel = ReadExcelData.ReadData(excelPath, "ErrorMessages", 1);
                Assert.AreEqual(countryErrorMessage, countryErrExcel);
                extentReports.CreateStepLogs("Passed", "Country specific error message is displayed: " + countryErrorMessage);

                addActivity.AddAnActivityWithNewCompany(fileTMTT0046706);
