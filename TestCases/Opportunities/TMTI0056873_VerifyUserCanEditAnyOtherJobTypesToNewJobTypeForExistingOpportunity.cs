...
{
    class TMTI0056873_VerifyUserCanEditAnyOtherJobTypesToNewJobTypeForExistingFVAOpportunity:BaseClass
    {
        ...
        public void ValidateJobTypesIsUpdatedWithNewJobTypeFVAOppDetailPage()
        {
            try
            {
                ...
                String jobTypeExl = ReadExcelData.ReadData(excelPath, "NewJobType", 1);
