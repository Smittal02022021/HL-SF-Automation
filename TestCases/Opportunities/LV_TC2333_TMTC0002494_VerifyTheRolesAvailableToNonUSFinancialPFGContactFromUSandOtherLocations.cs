...
{
    class LV_TC2333_TMTC0002494_VerifyTheRolesAvailableToNonUSFinancialPFGContactFromUSandOtherLocations : BaseClass
    {
        ...
        public void VerifyTheRolesAvailableLightningView()
        {
            try
            {
                ...
                string excelPath = ReadJSONData.data.filePaths.testData + fileT2333;
