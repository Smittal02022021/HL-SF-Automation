...
{
    class VT_TMTI0054683_TMTI0054712_VerificationOfNewFieldAssociatedOpportunityAvailabiltyAndFunctionalityOnFROpportunityAndEngagementPage : BaseClass
    {
        ...
        public static string fileTMTI0054683 = "TMTI0054683_VerificationOfNewFieldAssociatedOpportunityAvailabiltyAndFunctionalityOnFROpportunityAndEngagementPage";
        ...
        [Test]
        public void NewFieldAssociatedOpportunityAvailabiltyForFR()
        {
            try
            {
                ...
                for (int row = 2; row <= rowOpp; row++)
                {
                    ...
                    opportunityDetails.UpdateReqFieldsForFRConversion(fileTMTI0054683);
