        ...
        public void VerifySharingFeatureForCFDNDBOpportunityAndEngagementOnLightningView()
        {
            try
            {
                ...
                for (int row = 2; row <= rowOpp; row++)
                {
                    ...
                    extentReports.CreateStepLogs("Info", "Creating Opportunity for Job Type: " + valJobType);
                    string opportunityName = addOpportunity.AddOpportunitiesLightningV3(valRecordType, valJobType, fileTMTT0036859);
                    ...
                    addOpportunityContact.CreateContactL2(fileTMTT0036859, valRecordType);
                    extentReports.CreateStepLogs("Info", valContact + " is added as " + valContactType + " opportunity contact is saved ");

                    //Update required Opportunity fields for conversion and Internal team details
                    opportunityDetails.UpdateReqFieldsForCFConversionLV2(fileTMTT0036859, valJobType);                    
                    ...
                    randomPages.CloseActiveTab("Internal Tab");
                    ...
                    extentReports.CreateStepLogs("Passed", "System Admin User: " + adminUser + " User logged in ");
                    ...
                    /////////////////////////////////////////////////////////////////////
                    //TMTI0088201 Verify the functionality of internal sharing for DND and Non DND CF Opportunity                
                    ...
                    login.SwitchToClassicView();
                    usersLogin.UserLogOut();
                    extentReports.CreateStepLogs("Info", "User: " + caoUserExl + "switched to Classic and Loggout ");
                    ...
                    ///TMTI0088202	Verify the functionality of internal sharing for DND CF Engagements                    
