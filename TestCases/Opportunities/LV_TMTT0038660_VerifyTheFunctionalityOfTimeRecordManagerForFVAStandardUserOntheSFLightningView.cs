    ...
    class LV_TMTT0038660_VerifyTheFunctionalityOfTimeRecordManagerForFVAStandardUserOntheSFLightningView:BaseClass
    {
        ...
        public void VerifyTheFunctionalityOfTimeRecordManagerForFVAStandardUserLV()
        {
            try
            {
                ...
                string selectProject = ReadExcelData.ReadDataMultipleRows(excelPath, "SummaryLogs", 2, 1);
                ...
                extentReports.CreateStepLogs("Passed", "Hours entered on Weekly Entry Matrix ");

                //timeEntry.EnterWeeklyEntryMatrixLV(selectProject,fileTMTT0038660);
                //extentReports.CreateStepLogs("Passed", "Hours entered on Weekly Entry Matrix ");
                ...
                extentReports.CreateStepLogs("Passed", "Time Entry Deleted from Weekly Entry Matrix ");
                ...
                string textMessage= timeEntry.EnterSummaryLogsHoursLV(selectProject,fileTMTT0038660);
                Assert.AreEqual(textMessage, "Time Record Added"); 
                extentReports.CreateStepLogs("Passed", textMessage+" on Summary Logs Page ");
                
                timeEntry.DeleteTimeEntryLV();
                extentReports.CreateStepLogs("Passed", "Time Entry Deleted from Summary Logs Page ");
                ...
                textMessage = timeEntry.EnterDetailLogsHoursLV(selectProject, fileTMTT0038660);
                Assert.AreEqual(textMessage, "Time Record Added");
                extentReports.CreateStepLogs("Passed", textMessage+" on Detail Logs Page ");
