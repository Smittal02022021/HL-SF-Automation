...
namespace SF_Automation.TestCases.OpportunitiesInternalTeam
{
    class LV_CF_2_TMTT0048829_VerifyStaffRoleChangesImplementedOnInternalTeamForCaptialSolution:BaseClass
    {
        ...
        //TMTI0123309	Verify the roles available to Non-Registered US Financial Contacts in the Non-PFG US Opportunity deals
        //TMTI0123315 Verify the roles available to Non-Registered US Non-PFG Contacts in the US PFG Opportunity deals
        //TMTI0123355	Verify the roles available to Non-Financial US PFG Contacts in the any US PFG Opportunity deals.
        //TMTI0123357 Verify the roles available to Non-Financial US PFG Contacts in the any Non-US Opportunity deals
