    ...
    class TMTT0013765_TMTT0014798_TMTT0033330_VerifyTheAvailableFieldsOnNBCLightningFormAndAddFinancialLayout_ReviewSectionChanges: BaseClass
    {
        ...
        public void NBCFormSubmitforReview()
        {
            try
            {
                ...
                Assert.AreEqual("Conflicts Check Information - (the answers to each of these questions must be verified with each member of the deal team)", txtRestrictedInfo);
