    ...
    class TMTT0013767_TMTT0013772_TMTT0014070_TMTT0014796_NBCFormLightening_HeadersAndReqFields_SubmitforReview_EmailTemplate_DateSubmitted : BaseClass
    {
        ...
        public void NBCFormSubmitforReview()
        {
            try
            {
                ...
                Assert.AreEqual("Estimated Transaction Value\r\nEstimated Transaction Value should be greater than 0", actTxnValueValidation);
                ...
                Assert.AreEqual("A\r\nPublic Sensitivity: Please answer the Public Sensitivity question.", actAValidation);
                ...
                Assert.AreEqual("B\r\nPublic Sensitivity: Please answer the Public Sensitivity question.", actBValidation);
                ...
                Assert.AreEqual("C\r\nPublic Sensitivity: Please answer the Public Sensitivity question.", actCValidation);
                ...
                Assert.AreEqual("D\r\nPublic Sensitivity: Please answer the Public Sensitivity question.", actDValidation);
