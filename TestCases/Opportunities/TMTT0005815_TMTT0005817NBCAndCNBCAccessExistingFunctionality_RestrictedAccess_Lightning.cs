            ...
            try
            {
                ...
                for (int row = 2; row <= rowJobType; row++)
                {
                    ...
                    if (valUser.Equals("Derek Janisch"))
                    {
                        ...
                        string title1 = opportunityDetails.ValidateNBCFormButtonLightning();
                    ...
                    else 
                    {
                        ...
                        else if (valUser.Equals("Mark Fisher"))
                        {
                            string title1 = opportunityDetails.ClickNBCFormL();
                            Assert.AreEqual("Public Sensitivity", title1);
                            extentReports.CreateLog("Tab with name: " + title1 + " is displayed upon clicking NBC button for deal team member: " + valUser);
                            usersLogin.DiffLightningLogout();
                        }
