...
{
    class TMTT0013974_VerifyThePopUpLoadsToSelectTheFormType_Lightning : BaseClass
    {
        ...
        public void CNBCFormSubmitforReview()
        {
            try
            {
                ...
                Console.WriteLine("rowCount " + rowOpp);

                for (int row = 2; row <= rowOpp; row++)
                {
                    string valJobType = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", row, 3);
                    string valOpp = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", row, 29);
                    //Search for created opportunity
                    opportunityHome.SearchOpportunityUsingSearchBox(valOpp);
                    ...
                    {
                        string title = opportunityDetails.ClickNBCFormLAndValidatePopUp();
                        //Validate the pop up
                    ...
                    opportunityDetails.CloseOpportunityTab();
