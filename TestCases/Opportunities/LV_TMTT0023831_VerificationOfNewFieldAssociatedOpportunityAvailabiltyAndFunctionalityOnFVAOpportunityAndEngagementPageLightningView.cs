...
{
    class LV_TMTT0023831_VerificationOfNewFieldAssociatedOpportunityAvailabiltyAndFunctionalityOnFVAOpportunityAndEngagementPageLightningView: BaseClass
    {
        ...
        [Test]
        public void NewFieldAssociatedOpportunityAvailabiltyForFVALV()
        {
            try
            {
                //Get path of Test data file
                string excelPath = ReadJSONData.data.filePaths.testData + fileTMTI0054728;
                ...
                for (int row = 2; row <= rowOpp; row++)
                {
                    ...
                    string opportunityName = addOpportunity.AddOpportunitiesLightningV3(valRecordType, valJobType,fileTMTI0054728);
                    extentReports.CreateLog("Opportunity : " + opportunityName + " is created ");

                    //Call function to enter Internal Team details and validate Opportunity detail page
                    string displayedTab = addOpportunity.EnterStaffDetailsL(fileTMTI0054728);
                    ...
                    //TMTI0054728	Verification of new field named as "Associated Opportunity" availabilty and functionality on FVA Opportunity page.
                    ...
                    addOpportunityContact.CreateContactL2(fileTMTI0054728, valRecordType);
                    extentReports.CreateLog(valContactType + " Opportunity contact is saved ");

                    //Update required Opportunity fields for conversion and Internal team details
                    opportunityDetails.UpdateReqFieldsForFVAConversionLV(fileTMTI0054728);
                    ...
                    //Search for created opportunity
                    extentReports.CreateLog(userCAO + " CAO User Search for Created Opportunity");
                    opportunityHome.SearchOpportunitiesInLightningView(opportunityName);
                    ...
                    Assert.AreEqual(valAssociatedOpp, nameAssociatedOpp, "Verify Entered Associated Opportunity as saved ");
                    extentReports.CreateLog(userCAO + " Entered " + valAssociatedOpp + " as Associated Opportunity and " + nameAssociatedOpp + " is Saved ");
                    ...
                    extentReports.CreateLog("New Field i.e. Associated Opportunity is Present on Engagement Detail Page for CAO User: " + userCAO + " ");
                    ...
                    extentReports.CreateLog("New Field i.e. Associated Engagement is Editable for CAO User: " + userCAO + " ");
                    ...
                    Assert.AreEqual(valAssociatedEng,nameAssociatedEng,"Verify Entered Associated Engagement as saved ");
                    extentReports.CreateLog(userCAO + " Entered " + valAssociatedEng + " as Associated Engagement and " + nameAssociatedEng + " is Saved ");
