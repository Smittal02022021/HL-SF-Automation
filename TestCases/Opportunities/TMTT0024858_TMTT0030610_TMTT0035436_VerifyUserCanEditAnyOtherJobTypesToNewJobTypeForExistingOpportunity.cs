...
{
    class TMTT0024858_TMTT0030610_TMTT0035436_VerifyUserCanEditAnyOtherJobTypesToNewJobTypeForExistingFVAOpportunity : BaseClass
    {
        ...
        public void ValidateJobTypesIsUpdatedWithNewJobTypeFVAOppDetailPage()
        {
            try
            {
                ...
                //TMTI0084214 Verify user is able to edit any other Job types to new job type for existing opportunity
