...
{
    class LV_TC2329_TMTC0002479_VerifyTheRolesAvailableToNonRegisteredUSAndNonUSFinancialPFGContactInForeignOpportunityDeal:BaseClass
    {
        ...
        public void VerifyTheRolesAvailableLightningView()
        {
            try
            {
                ...
                string excelPath = ReadJSONData.data.filePaths.testData + fileT2329;
