...
{
    class ZObsolated__TC2331_TMTC0002485_VerifyTheRolesAvailableToRegisteredUSAndNonUSFinancialNonPFGContactInOpportunityOfPFAJobType : BaseClass
    {
        ...
        public static string ERP = "TC2331_TMTC0002485_VerifyTheRolesAvailable.xlsx";
        ...
        public void VerifyTheRolesAvailable()
        {
            try
            {
...

                {
                    ...
                    if (opp.Equals("Project Tenex III"))
                    {
                        if (name.Equals("Kevin Ma"))
                        {
