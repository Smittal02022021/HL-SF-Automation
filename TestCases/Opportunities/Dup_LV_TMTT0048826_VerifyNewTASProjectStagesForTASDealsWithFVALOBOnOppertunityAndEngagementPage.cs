...
{
    class Dup_LV_TMTT0048826_VerifyNewTASProjectStagesForTASDealsWithFVALOBOnOppertunityAndEngagementPage:BaseClass
    {
        ...
        public static string fileTMTT0048826 = "LV_TMTT0048826_VerifyNewTASProjectStagesForTASDealsWithFVALOBOnOppertunityAndEngagementPage";
        private string txtTASProjectStageExl;
        string valTASProjectStage;
        bool areTASProjectStatgeOptionsPresent;
        ...
        [Test]
        public void VerifyNewTASProjectStagesForTASDealsWithFVALOBOnOppertunityAndEngagementPageLV()
        {
            try
            {
                //Get path of Test data file
                string excelPath = ReadJSONData.data.filePaths.testData + fileTMTT0048826;
                ...
                for (int row = 2; row <= rowOpp; row++)
                {
                    ...
                    extentReports.CreateStepLogs("Info", "Creating Opportunity for Job Type: " + valJobType);
                    string opportunityName = addOpportunity.AddOpportunitiesLightningV3(valRecordType, valJobType, fileTMTT0048826);
                    extentReports.CreateStepLogs("Info", "Opportunity : " + opportunityName + " is created ");
                    //Call function to enter Internal Team details and validate Opportunity detail page
                    string displayedTab = addOpportunity.EnterStaffDetailsL(fileTMTT0048826);
                    ...
                    addOpportunityContact.CreateContactL2(fileTMTT0048826, valRecordType);
                    ...
                    opportunityDetails.UpdateReqFieldsForFVAConversionLV(fileTMTT0048826);
                    ...
                    opportunityDetails.UpdateInternalTeamDetailsLV(fileTMTT0048826);
                    ...
                    if(valJobType.Contains("TAS"))
                    {
                        ...
                        areTASProjectStatgeOptionsPresent = opportunityDetails.AreTASProjectStageDisplayedLV(fileTMTT0048826);
                    ...
                    //Request opp for Eng Conversion 
                    ...
                    if (valJobType.Contains("TAS"))
                    {
                        ...
                        areTASProjectStatgeOptionsPresent = engagementDetails.AreEngTASProjectStageDisplayedLV(fileTMTT0048826);
