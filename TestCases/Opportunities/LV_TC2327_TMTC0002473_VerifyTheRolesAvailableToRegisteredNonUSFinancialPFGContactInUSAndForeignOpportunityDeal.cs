...
{
    class LV_TC2327_TMTC0002473_VerifyTheRolesAvailableToRegisteredNonUSFinancialPFGContactInUSAndForeignOpportunityDeal: BaseClass
    {
        ...
        public void VerifyTheRolesAvailableLightningView()
        {
            ...
            {//Get path of Test data file
                string excelPath = ReadJSONData.data.filePaths.testData + fileT2327;
