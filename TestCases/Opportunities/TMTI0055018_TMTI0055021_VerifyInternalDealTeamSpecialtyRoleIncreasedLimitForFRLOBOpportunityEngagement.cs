...
{
    class TMTI0055018_TMTI0055021_VerifyInternalDealTeamSpecialtyRoleIncreasedLimitForFRLOBOpportunityEngagement : BaseClass
    {
        ...
        public void VerifyDealTeamSpecialtyRoleOnFROppEngManagerPage()
        {
            try
            {
                ...
                for (int row = 2; row <= rowOpp; row++)
                {
                    ...
                    countDealTeamMember = opportunityDetails.AddEngMultipleDealTeamMembers(valRecordType, fileTMTI0055018);
