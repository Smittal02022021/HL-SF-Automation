...
{
    class T1177_Companies_AddFROpportunityInCompanyDetailPage : BaseClass
    {
        ...
        public static string fileTC1177 = "T1177_Companies_AddFROpportunityOnCompanyDetailPage";
        ...
        public void AddFROpportunityInCompanyDetailsPage()
        {
            try
            {
                ...
                for (int row = 2; row <= rowCompanyName; row++)
                {
                    ...
                    companyHome.SearchCompany(fileTC1177, companyType);
                    ...
                    // Calling function ClickOpportunityButton to click on Add FR opportunity button
                    string CompanyType = ReadExcelData.ReadDataMultipleRows(excelPath, "Company", row, 1);
                    ...
                    companyDetail.ClickOpportunityButton(fileTC1177, CompanyType, HLCompanyValue, OtherCompanyValue);
                    ...
                    string value = addOpportunity.AddOpportunities(valJobType,fileTC1177);
                    Console.WriteLine("value : " + value);
                    extentReports.CreateLog("Opportunity is created succcessfully ");

                    //Call function to enter Internal Team details and validate Opportunity detail page
                    clientSubjectsPage.EnterStaffDetails(fileTC1177);
                    ...
                    (driver.Title).Contains("Salesforce - Unlimited Edition");
