...
{
    class ZObsolated_T1174_Companies_AddCFOpportunityInCompanyDetailsPage : BaseClass
    {
        ...
        public static string fileTC1174 = "T1174_Companies_AddCFOpportunityOnCompanyDetailPage";
        ...
        public void AddCFOpportunityInCompanyDetailsPage()
        {
            try
            {
                ...
                for (int row = 2; row <= rowCompanyName; row++)
                {
                    ...
                    homePage.SearchUserByGlobalSearch(fileTC1174, user);
                    ...
                    companyHome.SearchCompany(fileTC1174, companyType);
                    ...
                    companyDetail.ClickOpportunityButton(fileTC1174, CompanyType, HLCompanyValue, OtherCompanyValue);
                    ...
                    string value = addOpportunity.AddOpportunities(valJobType,fileTC1174);
                    Console.WriteLine("value : " + value);
                    extentReports.CreateLog("Opportunity is created succcessfully ");

                    //Call function to enter Internal Team details and validate Opportunity detail page
                    clientSubjectsPage.EnterStaffDetails(fileTC1174);
                    Assert.AreEqual(WebDriverWaits.TitleContains(driver, "Opportunity: " + value + " ~ Salesforce - Unlimited Edition"), true);
                    extentReports.CreateLog(driver.Title + " is displayed ");
                    
                    // Validate Line of business value
                    string lineOfBusiness = oppDetails.GetLOB();
                    string LOBExl = ReadExcelData.ReadData(excelPath, "AddOpportunity", 15);
                    Assert.AreEqual(LOBExl, lineOfBusiness);
                    extentReports.CreateLog("Line of Business: " + lineOfBusiness + " in add opportunity page matches on Opportunity details page ");
                    ...
                    string extDisclosureStat = oppDetails.GetExternalDisclosureStatus();
                    ...
                    extentReports.CreateLog("External disclosure status "+extDisclosureStat + " as opportunity external disclosure status matches on Opportunity details page ");
                    ...
                    //extentReports.CreateLog("Get opportunity details using opportunity name ");
                    ...
                    //oppHomePage.SearchOpportunity(value);
                    //Assert.AreEqual(value, opportunityNames);
                    //extentReports.CreateLog("Get opportunity details using opportunity name for second time ");
