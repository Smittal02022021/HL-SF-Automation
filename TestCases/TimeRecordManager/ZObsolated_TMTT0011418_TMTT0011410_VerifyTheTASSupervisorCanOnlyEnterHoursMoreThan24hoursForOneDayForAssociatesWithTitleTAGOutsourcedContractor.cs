...
{
    class ZObsolated_TMTT0011418_TMTT0011410_VerifyTheTASSupervisorCanOnlyEnterHoursMoreThan24hoursForOneDayForAssociatesWithTitleTAGOutsourcedContractor : BaseClass
    {
        ...
        public void VerifyTASSupervisorFunctionalities()
        {
            try
            {
                ...
                string DefaultRateForStaffString = timeEntry.GetDefaultRateForStaff();
