        ...
        public void VerifyTheFunctionalityOfTimeRecordManagerForFVASupervisorUserLV()
        {
            try
            {
                ...
                for (int row = 2; row <= rowCount; row++)
                {
                    ...
                    extentReports.CreateStepLogs("Passed", "Detail Log Value:: " + detailLogTimeEntryRoundOffExl + " is Rounded Off to Value: " + detailLogTimeEntryRoundOff + " is updated from more than one decimal value to one decimal value ");
