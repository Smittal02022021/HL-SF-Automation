...
using SF_Automation.Pages.Contacts;
...
{
    class TS27_TS30_VerifyNoIcoContractWhenLegalEntityIsCommonForOpportunityAndInternalStaff_Part2 : BaseClass
    {
        ...
        public static string ERPSectionWithExistingCompany = "TS27_TS30_VerifyNoIcoContractWhenLegalEntityIsCommon.xlsx";
        public static string xlPath = "TS27_TS30_EngagementDetails.xlsx";
        ...
        public void TestICOContractExistingCompany2()
        {
            try
            {
                ...
                for (int row = 2; row <= rowCompanyName; row++)
                {
                    ...
                    string IsICOContractCreated = engageDetail.ClickICOContractLink(row);
                    Assert.AreEqual("NO ICO contract created", IsICOContractCreated);
                    extentReports.CreateLog("ICO Contract Result: " + IsICOContractCreated + " ");
