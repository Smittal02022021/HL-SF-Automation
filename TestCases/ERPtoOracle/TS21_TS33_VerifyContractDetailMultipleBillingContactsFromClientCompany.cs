...
{
    class TS21_TS33_VerifyContractDetailMultipleBillingContactsFromClientCompany : BaseClass
    {
        ...
        public static string TS21 = "TS21_ERPInformationOfContractMultipleBillingContactsClientCompany.xlsx";
        ...
        public void TestERPInformationOfContractMultipleBillingContactsSameNonClientCompany()
        {
            try
            {
                ...
                string excelPath = ReadJSONData.data.filePaths.testData + TS21;
                ...
                for (int row = 2; row <= rowCompanyName; row++)
                {
                    ...
                    homePage.SearchUserByGlobalSearch(TS21, user);
                    ...
                    companyHome.SearchCompany(TS21, CompanyType);
                    ...
                    contactCreate.CreateContactFromCompany(TS21, valFirstName, valLastName, valEmail, row);
                    ...
                    companyDetail.ClickOpportunityButton(TS21, CompanyType, HLCompanyValue, OtherCompanyValue);
                    ...
                    string value = addOpportunity.AddOpportunities(valJobType, TS21, row);
                    Console.WriteLine("value : " + value);
                    extentReports.CreateLog("Opportunity is created succcessfully ");

                    //Call function to enter Internal Team details and validate Opportunity detail page
                    clientSubjectsPage.EnterStaffDetails(TS21);
                    ...
                    addOpportunityContact.CreateContact(TS21, valContact, valRecordType, valContactType, row);
                    ...
                    opportunityDetails.UpdateReqFieldsForConversion(TS21);
                    opportunityDetails.UpdateInternalTeamDetails(TS21);
                    ...
                    opportunityDetails.UpdateOutcomeDetails(TS21);
                    ...
                    string valueContactType = ReadExcelData.ReadData(excelPath, "AddContact", 4);
                    string valueContact = ReadExcelData.ReadDataMultipleRows(excelPath, "AddContact", 2, 1);
                    
                    string valueRecordType = ReadExcelData.ReadDataMultipleRows(excelPath, "AddOpportunity", row, 25);
                    engageDetail.CreateContact(TS21, valueContact, valRecordType, valContactType, row);

                    //addOpportunityContact.CreateContact(TS20, valueContact, valueRecordType, valContactType, row);

                    int contractsCount = engageDetail.numberOfContractCounts();
                    Assert.AreEqual(3, contractsCount);
                    extentReports.CreateLog("Contract count is increased to 2 after adding a billing contact ");

                    string newContractMainStatus = engageDetail.GetIsMainContractCheckBoxStatus(2);
                    Assert.AreEqual("Not Checked", newContractMainStatus);
                    ...
                    Assert.AreEqual("Checked", oldContractMainStatus);
                    extentReports.CreateLog("Old Contract Is Main Contract Status remain checked ");
