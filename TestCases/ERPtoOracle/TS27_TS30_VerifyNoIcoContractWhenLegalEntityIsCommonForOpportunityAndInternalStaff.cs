...
{
    class TS27_TS30_VerifyNoIcoContractWhenLegalEntityIsCommonForOpportunityAndInternalStaff : BaseClass
    {
        ...
        [Test]
        public void TestICOContractNonUsStaffAndUsLegalEntity()
        {
            try
            {
