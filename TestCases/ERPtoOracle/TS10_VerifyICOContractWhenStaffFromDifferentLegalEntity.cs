...
{
    class TS10_VerifyICOContractWhenStaffFromDifferentLegalEntity : BaseClass
    {
        ...
        [Test]
        public void TestICOContractOfDiffLegalEntity()
        {
            try
            {
                ...
                for (int row = 2; row <= rowCompanyName; row++)
                {
                    ...
                    extentReports.CreateLog("beforeERPSubmittedDate " + beforeERPSubmittedDate);
                    ...
                    extentReports.CreateLog("EngName: "+ engName+ " EngNumber: "+ engNumber);
