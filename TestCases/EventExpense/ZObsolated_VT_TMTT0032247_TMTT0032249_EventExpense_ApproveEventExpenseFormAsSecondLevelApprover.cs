...
{
    class ZObsolated_VT_TMTT0032247_TMTT0032249_EventExpense_ApproveEventExpenseFormAsSecondLevelApprover: BaseClass
    {
        ...
        public static string fileTMTI0075758 = "TMTI0075758_75760_75767_75769_EventExpense_ApproveEventExpenseFormAsSecondLevelApprover";
        ...
        public void ApproveEventExpenseFormAsSecondLevelApprover()
        {
            try
            {
                ...
                string excelPath = ReadJSONData.data.filePaths.testData + fileTMTI0075758;
                ...
                for (int row = 2; row <= rowExpenseRequest; row++)
                {
                    ...
                    homePage.SearchUserByGlobalSearch(fileTMTI0075758, user);
                    ...
                    expReqCreate.CreateExpenseRequest(row, fileTMTI0075758);
                    ...
                    extentReports.CreateLog("Expense Preapproval Number: " + expensePreAppNumber + " ");
                    ...
                    login.LoginAsFirstLevelExpenseRequest(fileTMTI0075758, row);
                    ...
                    login.LoginAsExpenseRequestApprover(fileTMTI0075758, row);
                    extentReports.CreateLog("Verified and Validation of User being redirected to Event Expense Form upon successful authentication ");
                    //Approve expense request
                    expReqDetail.ApproveExpenseRequest(1);
                    extentReports.CreateLog("Approved expense request ");
