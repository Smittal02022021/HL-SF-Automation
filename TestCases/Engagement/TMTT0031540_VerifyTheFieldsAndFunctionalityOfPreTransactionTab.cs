    ...
    class TMTT0031540_VerifyTheFieldsAndFunctionalityOfPreTransactionTab : BaseClass
    {
        ...
        public void VerifyTheFieldsAndFunctionalityOfPreTransTab()
        {
            try
            {
                ...
                Assert.AreEqual("Company Name : 'Dina' already exists as an Additional Client/Subject", msgSameClient);
                ...
                Assert.AreEqual("Company Name : 'Dina's Test Company Formula 2' already exists as an Additional Client/Subject", msgDupClientSub);
