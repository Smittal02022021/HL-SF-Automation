    ...
    class LV_TS06_ValidateERPSubmittedAndERPLastIntegrationResponsePostManualSyncEngagementLightningView:BaseClass
    {
        ...
        public void PostEngagementManualSyncLV()
        {
            try
            {
                ...
                extentReports.CreateLog("Opportunity with number : " + EngagementNumber + " is displayed ");
                ...
                extentReports.CreateLog("ERP Submitted to Sync Old:: "+ ERPSubmitted+ " New:: "+ ERPSubmittedPostSync + " is updated post scheduling ERP sync ");
