...
{
    class LV_T1177_TMTC0034002_CompaniesAddFROpportunityInCompanyDetailPage : BaseClass
    {
        ...
        public static string fileTC1177 = "LV_T1177_CompaniesAddFROpportunityInCompanyDetailPage";
        [OneTimeSetUp]
         ...
         */
        //TMT0076383 Verify the availability of the "Add FR Opportunity" tab on the Company detail page.
        //TMT0076385 Verify that clicking "Add FR Opportunity"  navigates to the New Opportunity Page and is prefilled with the selected company's name, Line of Business, and Record Type as FR.
        //TMT0076387 Verify that clicking the "Cancel" button navigates the user back to the Company details page.
        //TMT0076389 Verify that on clicking the "Save" button of New Opportunity: CF page creates the New FR Opportunity with provided details and redirects the user to the Opportunity detail page.

        [Test]
        public void AddFROpportunityInCompanyDetailsPage()
        {
            try
            {
                //Get path of Test data file
                string excelPath = ReadJSONData.data.filePaths.testData + fileTC1177;
                ...
                for(int row = 2; row <= rowCompanyName - 2; row++)
                {
                    ...
                    string opportunityName = addOpportunity.AddCompanyOpportunitiesLightningView(companyNameExl, valOppLOBExl, valJobType, fileTC1177);
                    extentReports.CreateStepLogs("Info", "Opportunity : " + opportunityName + " is created ");

                    //Call function to enter Internal Team details and validate Opportunity detail page
                    string displayedTab = addOpportunity.EnterStaffDetailsL(fileTC1177);
