...
namespace SF_Automation.TestCases.Companies
{
    class LV_T1174_TMTC0033995_CompaniesAddCFOpportunityInCompanyDetailsPage : BaseClass
    {
         ...
         */
        //TMT0076374 Verify the availability of the "Add CF Opportunity" tab on the Company detail page.
        //TMT0076376 Verify that clicking "Add CF Opportunity"  navigates to the New Opportunity Page and is prefilled with the selected company's name, Line of Business, and Record Type as CF.
        //TMT0076378 Verify that clicking the "Cancel" button navigates the user back to the Company details page.
        //TMT0076380 Verify that on clicking the "Save" button of New Opportunity: CF page creates the New CF Opportunity with provided details and redirects the user to the Opportunity detail page.
