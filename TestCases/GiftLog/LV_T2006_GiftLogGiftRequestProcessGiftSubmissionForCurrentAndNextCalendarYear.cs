    ...
    class LV_T2006_GiftLogGiftRequestProcessGiftSubmissionForCurrentAndNextCalendarYear:BaseClass
    {
        ...
        public void VerifyGiftRequestProcessGiftSubmissionForCurrentAndNextCalendarYearLV()
        {
            try
            {
                ...
                string excelPath = ReadJSONData.data.filePaths.testData + fileT2006;
                ...
                string errorExl = ReadExcelData.ReadData(excelPath, "Error", 1);
                string DesiredDateError = giftRequest.GetDesiredDateErrorMsgLV();
                Assert.AreEqual(errorExl, DesiredDateError);
