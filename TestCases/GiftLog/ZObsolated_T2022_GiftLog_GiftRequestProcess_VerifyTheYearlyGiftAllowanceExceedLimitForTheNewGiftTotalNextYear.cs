...
{
    class ZObsolated_T2022_GiftLog_GiftRequestProcess_VerifyTheYearlyGiftAllowanceExceedLimitForTheNewGiftTotalNextYear : BaseClass
    {
        ...
        public void GiftRequestProcess_VerifyTheYearlyGiftAllowanceExceedLimitForTheNewGiftTotalNextYear()
        {
            try
            {
                ...
                string DesireDate = giftRequest.EnterDesiredDate(360);//364
