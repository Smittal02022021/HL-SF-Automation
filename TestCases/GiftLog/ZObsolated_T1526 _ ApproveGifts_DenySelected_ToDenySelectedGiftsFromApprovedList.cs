...
{
    class ZObsolated_T1526_ApproveGifts_DenySelected_ToDenySelectedGiftsFromApprovedList : BaseClass
    {
        ...
        public static string fileTC1526 = "T1526_ApproveGifts_DenySelected_ToDenySelectedGiftsFromApprovedList";
        ...
        public void GiftLog_GiftApprovalProcess_ApproveGifts_VerifyPendingApprovedAndDeniedGiftsEditRights()
        {
            try
            {
                ...
                string excelPath = ReadJSONData.data.filePaths.testData + fileTC1526;
                ...
                homePage.SearchUserByGlobalSearch(fileTC1526, userCompliance);
