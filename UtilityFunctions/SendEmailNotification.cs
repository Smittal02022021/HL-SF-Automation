    ...
    public class SendEmailNotification
    {
        ...
        public void SendOutlookEmailWithTestExecutionReport(string Subject)
        {
            try
            {
                ...
                mail.From = new MailAddress("vkumar0427@HL.com");
                ...
                mail.To.Add(new MailAddress("vkumar0427@HL.com"));                ;
                //mail.CC.Add("vkumar0427@HL.com");
                ...
                client.EnableSsl = true;
                client.UseDefaultCredentials = false;
                client.Credentials = new NetworkCredential("vkumar0427", "Angeles!2021");
                client.Send(mail);
            }
            catch (System.Exception e)
            {
