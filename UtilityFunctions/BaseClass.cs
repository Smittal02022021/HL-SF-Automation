...
namespace SF_Automation.UtilityFunctions
{
    public class BaseClass
    {
        ...
        {
            string path = @"C:\Users\YRamann\source\repos\SF_Automation\TestData\User Data";
        ...
        public IWebDriver Initialize1()
        {
            ...
            options.AddArguments("user-data-dir=" + path);
            options.AddArguments("profile-directory=Default");
            options.AddUserProfilePreference("download.default_directory", @"C:\Users\YRamann\source\repos\SF_Automation\TestData\User Data");
            driver = new ChromeDriver(options);
        ...
        {
            string path = @"C:\Users\YRamann\source\repos\SF_Automation\TestData";
            ChromeOptions options = new ChromeOptions();
            options.AddArguments("user-data-dir=" + path);
            options.AddArguments("profile-directory=Default");
            options.AddUserProfilePreference("download.default_directory", @"C:\Users\YRamann\source\repos\SF_Automation\TestData\User Data");
        ...
        public static ExtentReports ExtentReportHelper()
        {
            if(extent == null)
            {
                ...
                string path = @"C:\Users\YRamann\source\repos\SF_Automation\Reports\";
                ...
                //var htmlReporter = new ExtentHtmlReporter(@"C:\Users\YRamann\source\repos\SF_Automation\Reports\ExtentReport.html");
